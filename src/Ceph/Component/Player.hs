...
player :: Txtr -> M.Chunk -> M.Chunk -> System World Entity
player txtr a b = newEntity (( Position (V2 0 50)
                        , 0 :: Velocity
                        , Gravity (V2 0 (0.1))
                        , txtr
                        , Box (0, 1, 1))
                       ...
                       , (Player1, Player)
                       , SpriteColor (S.V4 0 0 0 255)
                       , (NoBehavior, Charge 0.01 False, SFXResources a b []))
