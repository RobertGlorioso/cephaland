...
--refactor init to delegate to various components
...
main = do
  ...
  where 
    initGame r = do
      ...
      let wallFile = "C:/Users/robertg/OneDrive/cephaland-master/resource/image/canvas.bmp"
      ...
      mapM_ (enemy enmTexture) $ take 100 $ zip bcs pfs
